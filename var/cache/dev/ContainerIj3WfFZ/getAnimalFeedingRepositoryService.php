 ...
 */
class getAnimalFeedingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnimalFeedingRepository' shared autowired service.
     *
     * @return \App\Repository\AnimalFeedingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnimalFeedingRepository.php';

        return $container->privates['App\\Repository\\AnimalFeedingRepository'] = new \App\Repository\AnimalFeedingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
