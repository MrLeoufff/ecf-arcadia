...
class __TwigTemplate_77ee3194aadb8bc94e8241b0d420e71e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <h1>Create New Habitat</h1>
...
{% block title %}Create New Habitat{% endblock %}

{% block body %}
    <h1>Create New Habitat</h1>
    ...
    <a href=\"{{ path('app_habitat_index') }}\" class=\"btn btn-secondary\">Back to list</a>
{% endblock %}
