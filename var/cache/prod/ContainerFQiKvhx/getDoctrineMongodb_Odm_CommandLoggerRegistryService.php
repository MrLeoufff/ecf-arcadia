...
class getDoctrineMongodb_Odm_CommandLoggerRegistryService extends App_KernelProdContainer
{
    ...
    {
        return $container->services['doctrine_mongodb.odm.command_logger_registry'] = new \Doctrine\Bundle\MongoDBBundle\APM\CommandLoggerRegistry(new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
}
