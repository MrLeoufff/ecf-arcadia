...
class getDoctrineMongodb_Odm_DefaultDocumentManagerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['doctrine_mongodb.odm.default_document_manager'] = $instance = \Doctrine\ODM\MongoDB\DocumentManager::create(($container->services['doctrine_mongodb.odm.default_connection'] ?? $container->load('getDoctrineMongodb_Odm_DefaultConnectionService')), ($container->privates['doctrine_mongodb.odm.default_configuration'] ?? $container->load('getDoctrineMongodb_Odm_DefaultConfigurationService')), ($container->privates['doctrine_mongodb.odm.default_connection.event_manager'] ??= new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($container)));

        ($container->privates['doctrine_mongodb.odm.default_manager_configurator'] ??= new \Doctrine\Bundle\MongoDBBundle\ManagerConfigurator([]))->configure($instance);
