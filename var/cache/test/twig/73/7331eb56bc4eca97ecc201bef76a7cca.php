...
/* user/list.html.twig */
class __TwigTemplate_29a5bbc84784be706b76a1fe9d565997 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "</td>
                <td>";
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "roles", [], "any", false, false, false, 22), ", "), "html", null, true);
            yield "</td>
                <td>
                    <a href=\"";
            // line 24
            ...
            yield "\">Edit</a>
                    ";
            // line 25
            if (!CoreExtension::inFilter("ROLE_ADMIN", CoreExtension::getAttribute($this->env, $this->source, $context["user"], "roles", [], "any", false, false, false, 25))) {
                // line 26
                yield "                    <form method=\"post\" action=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 26)]), "html", null, true);
                yield "\" onsubmit=\"return confirm('Are you sure you want to delete this user?');\">
                        <input type=\"hidden\" name=\"_token\" value=\"";
                // line 27
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 27))), "html", null, true);
                yield "\">
...
";
    ...
    {
        return array (  134 => 34,  126 => 31,  119 => 27,  114 => 26,  112 => 25,  108 => 24,  103 => 22,  99 => 21,  95 => 20,  92 => 19,  88 => 18,  73 => 6,  69 => 4,  59 => 3,  36 => 1,);
    }
