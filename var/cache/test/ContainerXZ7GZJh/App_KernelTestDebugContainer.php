...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AnimalFeedingController' => 'getAnimalFeedingControllerService',
            ...
            'App\\Controller\\VeterinaryReportController' => 'getVeterinaryReportControllerService',
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $container->services['doctrine.dbal.default_connection'] = $instance = ($container->privates['doctrine.dbal.connection_factory'] ?? self::getDoctrine_Dbal_ConnectionFactoryService($container))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'use_savepoints' => true, 'dbname_suffix' => '_test'.$container->getEnv('string:default::TEST_TOKEN'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], ($container->privates['doctrine.dbal.default_connection.configuration'] ?? self::getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)), $a, []);
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NFnod5SfDd', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.asset_mapper.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GWFyJXGyOb', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tUa2bCMAc8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XLjx4bFgc7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_csrf_token_valid_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NglwBytfZl', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jrWz4eiDDw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XxdTpaQnU7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TXVx+Y-uZD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0tfITdCmwg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gvFJGl+4QR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AnimalController', 'App\\Controller\\AnimalFeedingController', 'App\\Controller\\ContactController', 'App\\Controller\\DashboardController', 'App\\Controller\\DefaultController', 'App\\Controller\\HabitatController', 'App\\Controller\\LegalController', 'App\\Controller\\PasswordResetController', 'App\\Controller\\ReviewController', 'App\\Controller\\ScheduleController', 'App\\Controller\\SecurityController', 'App\\Controller\\ServiceController', 'App\\Controller\\UserController', 'App\\Controller\\VeterinaryReportController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\AnimalFeedingRepository' => ['privates', 'App\\Repository\\AnimalFeedingRepository', 'getAnimalFeedingRepositoryService', true],
            ...
            'App\\Repository\\VeterinaryReportRepository' => ['privates', 'App\\Repository\\VeterinaryReportRepository', 'getVeterinaryReportRepositoryService', true],
        ], [
     ...
     * @return \Symfony\Bridge\Doctrine\Validator\DoctrineInitializer
     */
    protected static function getDoctrineOdm_Mongodb_ValidatorInitializerService($container)
    {
        return $container->privates['doctrine_odm.mongodb.validator_initializer'] = new \Symfony\Bridge\Doctrine\Validator\DoctrineInitializer(($container->services['doctrine_mongodb'] ?? self::getDoctrineMongodbService($container)));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(($container->privates['twig.extension.cssinliner'] ??= new \Twig\Extra\CssInliner\CssInlinerExtension()));
        $instance->addExtension(($container->privates['twig.extension.inky'] ??= new \Twig\Extra\Inky\InkyExtension()));
     ...
     */
    protected static function getTwig_Extension_CssinlinerService($container)
    {
        return $container->privates['twig.extension.cssinliner'] = new \Twig\Extra\CssInliner\CssInlinerExtension();
    }
     ...
     */
    protected static function getTwig_Extension_InkyService($container)
    {
        return $container->privates['twig.extension.inky'] = new \Twig\Extra\Inky\InkyExtension();
    }
    ...
    protected static function getTwig_Loader_NativeFilesystemService($container)
    {
        ...
        $instance->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'security-bundle/Resources/views'), '!Security');
        $instance->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'mongodb-odm-bundle/templates'), 'DoctrineMongoDB');
        $instance->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'mongodb-odm-bundle/templates'), '!DoctrineMongoDB');
    ...
    protected static function getValidator_BuilderService($container)
    {
        ...
        $instance->addObjectInitializers([($container->privates['doctrine.orm.validator_initializer'] ?? self::getDoctrine_Orm_ValidatorInitializerService($container)), ($container->privates['doctrine_odm.mongodb.validator_initializer'] ?? self::getDoctrineOdm_Mongodb_ValidatorInitializerService($container))]);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'zoo_email' => 'jurasikarcadia@gmail.com',
            'env(MONGODB_URL)' => '',
            'env(MONGODB_DB)' => '',
