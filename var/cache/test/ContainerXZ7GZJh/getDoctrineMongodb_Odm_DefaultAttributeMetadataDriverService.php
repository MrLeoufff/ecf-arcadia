...
class getDoctrineMongodb_Odm_DefaultAttributeMetadataDriverService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['doctrine_mongodb.odm.default_attribute_metadata_driver'] = new \Doctrine\ODM\MongoDB\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Document')]);
    }
}
